          ...
          <div class="border-top-blue bg-white">
            ...
            <div class="form-container p-md">
              <div class="form-item-container">
                ...
                <div><el-input disabled></el-input></div>
              </div>
              <div class="form-item-container m-t-sm">
                <div class="m-b-xs">Email:</div>
                <div><el-input placeholder="请输入Email"></el-input></div>
              </div>
              <div class="form-item-container m-t-sm">
                <div class="m-b-xs">昵称:</div>
                <div><el-input placeholder="请输入昵称"></el-input></div>
              </div>
              <div class="form-item-container m-t-sm">
                <div class="m-b-xs">手机号:</div>
                <div><el-input placeholder="请输入手机号"></el-input></div>
              </div>
              <div class="form-item-container m-t-sm">
                <div class="m-b-xs">密码:</div>
                <div><el-input placeholder="请输入密码"></el-input></div>
              </div>
                ...
                <div>
                  ...
                  <div class="lk-table m-t-sm">
                    ...
                    <ul class="table-tbody clear">
                      ...
                      <li class="col-xs-5 p-n over-omit" v-show="selectVal.indexOf('链接')!=-1">正常</li>
                      <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('IP')!=-1">IP</li>
                      <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('操作时间')!=-1">操作时间</li>
                    </ul>
                  </div>
