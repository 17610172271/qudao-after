  ...
  <div class="scroll-x">
          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('姓名')!=-1">青春无敌</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('英文名称')!=-1">90</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('生日')!=-1">正常</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('国家地区')!=-1">国家地区</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('性别')!=-1">性别</li>
    ...
    <el-dialog
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10"><el-input style="max-width: 300px;" placeholder="请输入英文名称"></el-input></div>
      </div>
      <div class="clear m-b-md">
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10"><el-input style="max-width: 300px;" placeholder="请输入国家"></el-input></div>
      </div>
      <div class="clear m-b-md">
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10 clear">
          <el-input style="max-width: 300px;" class="pull-left m-r-sm" placeholder="请输入英文名称"></el-input>
          <el-upload
