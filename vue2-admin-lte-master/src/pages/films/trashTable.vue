  ...
  <div>
    ...
    <div class="lk-table m-t-sm">
      ...
      <ul class="table-tbody clear">
        ...
        <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('时长')!=-1">90</li>
        <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('语言')!=-1">普通话</li>
        ...
        <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('类型')!=-1">歌舞,冒险,谍战</li>
        ...
        <li class="col-xs-2 p-n" v-show="selectVal.indexOf('操作')!=-1">
          <a href="javascript:;" title="还原" class="candle-btn btn"><i class="fa fa-undo"></i></a>
