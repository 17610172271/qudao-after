  ...
  <div>
    ...
    <div class="lk-table m-t-sm">
      ...
      <ul class="table-tbody clear">
        ...
        <li class="col-xs-24 p-n over-omit" v-show="selectVal.indexOf('审核状态')!=-1">未审核</li>
        <li class="col-xs-24 p-n over-omit" v-show="selectVal.indexOf('状态')!=-1">已上线</li>
        <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('原因')!=-1">----------</li>
        <li class="col-xs-2 p-n" v-show="selectVal.indexOf('操作')!=-1">
          ...
          <router-link :to="{name: 'films_add'}" title="编辑" class="candle-btn btn"><i class="fa fa-edit"></i></router-link>
          <a href="javascript:;" title="下线" class="candle-btn btn" @click="delItem"><i class="fa fa-level-down"></i></a>
