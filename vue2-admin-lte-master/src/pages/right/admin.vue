  ...
  <div class="scroll-x">
          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('昵称')!=-1">90</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('所属组别')!=-1">正常</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('Email')!=-1">Email</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('状态')!=-1">状态</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('最后登录')!=-1">最后登录</li>
    ...
    <el-dialog
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入用户名"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-sm-2 line-height-40 text-right attr-edit-name p-n">Email:</div>
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入Email"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-sm-2 line-height-40 text-right attr-edit-name p-n">昵称:</div>
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入昵称"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-sm-2 line-height-40 text-right attr-edit-name p-n">手机号:</div>
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入手机号"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-sm-2 line-height-40 text-right attr-edit-name p-n">密码:</div>
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入密码"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-sm-2 line-height-40 text-right attr-edit-name p-n">登录失败次数:</div>
        <div class="col-xs-12 col-sm-8"><el-input placeholder="请输入登录失败次数"></el-input></div>
      </div>
      <div class="clear m-b-md">
