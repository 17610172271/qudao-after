  ...
  <div class="scroll-x">
          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                <li class="col-xs-1 p-n" v-show="selectVal.indexOf('电影ID')!=-1">1</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('版权商')!=-1">xxx电影公司</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('电影名称')!=-1">青春无敌</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('单价(元)')!=-1">998.00</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('录入时间')!=-1">2018-06-28</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('操作时间')!=-1">2018-06-28</li>
                <li class="col-xs-2 p-n" v-show="selectVal.indexOf('操作')!=-1">
                  <a href="javascript:;" title="重置密码" class="candle-btn btn"><i class="fa fa-undo"></i></a>
    ...
    <el-dialog
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10"><el-input placeholder="请输入中文名称" style="max-width: 300px;"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-md-2 line-height-40 text-right attr-edit-name">电影名称:</div>
        <div class="col-xs-12 col-md-10"><el-input style="max-width: 300px;" placeholder="请输入电影名称"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-md-2 line-height-40 text-right attr-edit-name">单价(元)</div>
        <div class="col-xs-12 col-md-10"><el-input style="max-width: 300px;" placeholder="请输入单价(元)"></el-input></div>
      </div>
      <div class="clear m-b-md">
        <div class="col-xs-12 col-md-2 line-height-40 text-right attr-edit-name">录入时间:</div>
      ...
      <div class="clear m-b-md">
        <div class="col-xs-12 col-md-2 line-height-40 text-right attr-edit-name">操作时间:</div>
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10 clear">
          <el-input style="max-width: 300px;" class="pull-left m-r-sm" placeholder="请输入电影名称"></el-input>
          <el-upload
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-8"><el-input type="textarea" placeholder="请输入内容" rows="4"></el-input></div>
      </div>
      <div class="clear m-b-md">
...
<script>
  ...
  export default {
    data: () => ({
      ...
      selectVal: ['checkbox', '电影ID', '版权商', '电影名称', '单价(元)', '录入时间', '操作时间', '状态', '操作'],
      selectedGroup: [],
      selectAll: false,
      showList: ['checkbox', '电影ID', '版权商', '电影名称', '单价(元)', '录入时间', '操作时间', '状态','操作'],
      searchOptions: [
        {
          type: 'text',
          name: '版权商',
