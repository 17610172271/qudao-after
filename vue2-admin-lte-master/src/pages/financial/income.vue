  ...
  <div class="scroll-x">
          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('日期')!=-1">2018-06-28</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('电影编号')!=-1">2018061822</li>
                <li class="col-xs-3 p-n over-omit" v-show="selectVal.indexOf('电影名称')!=-1">青春无敌</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('购买数量')!=-1">998</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('收入(元)')!=-1">998</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('分成比例(%)')!=-1">10</li>
              </ul>
            </div>
    ...
    <el-dialog
      ...
      <div class="clear m-b-md">
        ...
        <div class="col-xs-12 col-md-10"><el-input style="max-width: 300px;" placeholder="请输入电影编号"></el-input></div>
      </div>
      <div class="clear m-b-md">
