          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-1 p-n" v-show="selectVal.indexOf('权重')!=-1">4</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('常用词汇')!=-1">青春无敌</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('添加人')!=-1">青春无敌</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('添加时间')!=-1">青春无敌</li>
