          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('审核人')!=-1">90</li>
                <li class="col-xs-2 p-n over-omit" v-show="selectVal.indexOf('创建时间')!=-1">正常</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('审核状态')!=-1">审核状态</li>
                <li class="col-xs-3 p-n over-omit" v-show="selectVal.indexOf('原因')!=-1">原因</li>
                <li class="col-xs-24 p-n over-omit" v-show="selectVal.indexOf('状态')!=-1">状态</li>
