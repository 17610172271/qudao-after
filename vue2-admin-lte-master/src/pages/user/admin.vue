          ...
          <div>
            ...
            <div class="lk-table m-t-sm">
              ...
              <ul class="table-tbody clear">
                ...
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('用户名')!=-1">青春无敌</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('姓名')!=-1">90</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('性别')!=-1">正常</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('角色')!=-1">角色</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('邮箱')!=-1">邮箱</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('手机号')!=-1">手机号</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('状态')!=-1">状态</li>
                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('最后登录')!=-1">最后登录</li>
