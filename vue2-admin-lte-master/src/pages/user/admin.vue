                    ...
                    <div>
                        ...
                        <div class="lk-table m-t-sm">
                            ...
                            <ul class="table-tbody clear" v-for="(item, index) in data.rows">
                                ...
                                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('角色')!=-1">{{item.role}}</li>
                                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('邮箱')!=-1">{{item.email}}</li>
                                <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('手机号')!=-1">{{item.tel}}</li>
